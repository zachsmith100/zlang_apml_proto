...
public:
	...
	void AddMethodExt(const std::string& name, const unsigned int parametersCount, const unsigned int minParametersCount, const unsigned int line, const std::vector<MethodParameter>& parameters, const bool noDeclareMethod, const std::string& defaultResultField);
	...
	bool IsVariableParameterMethod(const std::string& methodName);
