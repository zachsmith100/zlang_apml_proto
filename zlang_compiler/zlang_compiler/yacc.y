...
fp_number_exp:
	...
	|
	INTEGER_DECL										{ $$ = mkcmdnode(NULL, NULL, NULL, OP_INTEGER_DECL); } 
	|
	INTEGER_DECL PARENS_START math_exp PARENS_END						{ $$ = mkcmdnode($3, NULL, NULL, OP_INTEGER_DECL); } 
	|
	FLOAT_DECL										{ $$ = mkcmdnode(NULL, NULL, NULL, OP_DOUBLE_DECL); } 
	|
	FLOAT_DECL PARENS_START math_exp PARENS_END						{ $$ = mkcmdnode($3, NULL, NULL, OP_DOUBLE_DECL); } 
	|
	FLOAT_DECL COMPARE_LESS number_exp COMPARE_MORE PARENS_START math_exp PARENS_END	{ $$ = mkcmdnode($3, $6, NULL, OP_ARB_FLOAT_DECL); }	
	|
	FLOAT_DECL COMPARE_LESS number_exp COMPARE_MORE 					{ $$ = mkcmdnode($3, NULL, NULL, OP_ARB_FLOAT_DECL); }	
	|
	FIXED_DECL COMPARE_LESS number_exp COMPARE_MORE PARENS_START math_exp PARENS_END	{ $$ = mkcmdnode($3, $6, NULL, OP_ARB_FIXED_DECL); }	
	|
	FIXED_DECL COMPARE_LESS number_exp COMPARE_MORE						{ $$ = mkcmdnode($3, NULL, NULL, OP_ARB_FIXED_DECL); }	
	;
